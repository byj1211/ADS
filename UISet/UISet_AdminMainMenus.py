...
from UI.py import UI_AdminMainMenus as UI


class AdminMainMenusWindow(QMainWindow, UI.Ui_MainWindow):
    def __init__(self, parent=None):
        super(AdminMainMenusWindow, self).__init__(parent)
...
if __name__ == "__main__":
    ...
    AdminMainMenusWindow = AdminMainMenusWindow()
    AdminMainMenusWindow.show()
    sys.exit(app.exec_())
